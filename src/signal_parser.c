        ...
        case UNSIGNED:                                                   \
            return (_type)apply_linear_##_type(                          \
                big_endian_conv((uint64_t)                               \
                                    get_bitfield(can_word(msg), signal), \
                    signal),                                             \
                signal);                                                 \
        case SIGNED:                                                     \
            return (_type)apply_linear_##_type(                          \
                bitfield_sign_conv(                                      \
                    big_endian_conv(                                     \
                        get_bitfield(can_word(msg), signal), signal),    \
                    signal),                                             \
                signal);                                                 \
        case FLOAT:                                                      \
...
#define encode_signal(_type)                                                      \
    ...
    {                                                                             \
        ...
        case UNSIGNED:                                                            \
            return set_bitfield(                                                  \
                big_endian_conv(                                                  \
                    apply_linear_uint64_t((uint64_t)value, signal), signal),      \
                signal);                                                          \
        case SIGNED:                                                              \
            return set_bitfield(                                                  \
                big_endian_conv((uint64_t)                                        \
                                    apply_linear_int64_t((int64_t)value, signal), \
                    signal),                                                      \
                signal);                                                          \
        case FLOAT:                                                               \
